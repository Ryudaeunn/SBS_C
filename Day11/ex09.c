...
/*
    문자열 처리함수
    : 문자열 길이, 문자열 복사/결합/비교 등의 기능을 사용한 함수
   
    - string.h 헤더파일에 정의되어 있다.
    
    * 종류
    strcat(str1, str2)          : str2를 str1 뒤에 연결
    strncat(str1, str2, count)  : str2를 str1 뒤에 count 개수만큼 연결
...
int main(){
    ...
    strncat(str2, "입니다. 즐거운 주말 되세요.", 7);    //7은 바이트 수
    printf("%s \n", str2);
